    ...
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center
      ...
      <div className='text-center mb-6'>
        ...
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-grey-600'>
            Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your content.</p>
      <br/>
      ...
      <div className='flex items-center gap-4 mx-auto text-grey-600'>
