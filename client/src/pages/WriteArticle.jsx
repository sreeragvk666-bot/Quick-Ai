    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button disabled={loading}
          ...
          text-white py-2 px-4 rounded-lg text-sm hover:opacity-90 cursor-pointer"
        >
          {
            loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-spin'></span> : <Edit className="w-5 h-5" />
          }
          Generate Article
        </button>
      </form>
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        ...
        {!content ? (
          ...
          <div className='text-sm flex flex-col items-center gap-5'>
            ...
            <p className='mt-2 text-gray-400 italic'>Your generated article will appear here.</p>
          </div>
        </div>
        ):(
