  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <span className="block truncate text-left">{input ? input.name : "Click to upload PDF resume"}</span>
        <input type="file" accept="application/pdf" onChange={(e) => setInput(e.target.files[0])} className="hidden" required/>
        </label>
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        ...
        </div>
        {
          ...
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            ...
            <p className="italic">
              Your processed resume will appear here.
            </p>
          </div>
        </div>
          ) : (
